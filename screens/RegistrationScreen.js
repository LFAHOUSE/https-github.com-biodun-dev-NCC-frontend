  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.loginText}>Login to access your account</Text>
        ...
        <View style={styles.signUpContainer}>
          <TouchableOpacity onPress={() => navigation.navigate("SignUp")}>
            <Text style={styles.signUpText}>
              Don’t have account,<Text style={styles.sign}>Sign Up</Text>
            </Text>
          </TouchableOpacity>
          <TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  logoContainer: {
    alignItems: "center",
    flexDirection: "row",
    justifyContent: "center", // Center the logo and text horizontally
