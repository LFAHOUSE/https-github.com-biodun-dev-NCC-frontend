...
// A function that takes an item from the groupedEvents array and renders it as a component
const RenderLibEvents = ({ item,index,collapsed,toggleSection}) => {
  // const [collapsed, setCollapsed] = useState(
  //   // initialize it with an array of true values
  //   item?.map(() => true)
  // );
  // Destructure the item object to get the month and events properties
  let { month, events } = item;

  // Return a View component that contains a Text component for the month name and a FlatList component for the events
  return (
    ...
    <View style={styles.monthAndLogo}>
        ...
        {collapsed ?  <TouchableOpacity style={styles.logoContainer}  onPress={()=>toggleSection(index)} activeOpacity={0.8} >
...
export default RenderLibEvents
